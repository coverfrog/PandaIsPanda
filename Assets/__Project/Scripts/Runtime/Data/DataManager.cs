...
namespace PandaIsPanda
{
    public class DataManager : MonoBehaviour
    {
        ...
        public IReadOnlyDictionary<ulong, StatConstant> StatConstants { get; private set; }
        ...
        public async UniTask LoadAllAsync()
        {
            ...
            (
                ...
                AddressableUtil.LoadAsync<StatConstantTable>("constanttable/stat")
                    .ContinueWith(d => StatConstants = d.Data)
                );
        }
